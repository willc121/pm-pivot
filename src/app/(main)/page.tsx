...
export default function Home() {
  return (
    <main className="min-h-screen bg-background text-foreground noise-overlay">
      ...
      <section className="relative mx-auto max-w-7xl px-6 pt-16 pb-10 lg:pt-20">
        <div className="flex items-center justify-between gap-16">
          ...
          <div className="min-w-0 flex-1">
            ...
            {/* Lead */}
            <p className="animate-fade-in-up delay-300 mt-7 max-w-2xl text-[1.05rem] leading-relaxed text-white/60">
            ...
            {/* Metadata readout */}
            <dl className="animate-fade-in-up delay-400 mt-9 grid max-w-xl grid-cols-3 gap-px overflow-hidden rounded-lg border border-white/[0.08] bg-white/[0.02]">
              {metrics.map((m) => (
            ...
            {/* CTAs */}
            <div className="animate-fade-in-up delay-500 mt-9 flex flex-wrap items-center gap-3">
              <Link
                href="#work"
          ...
          {/* Right: helicopter in a HUD viewport */}
          <div className="animate-fade-in-up delay-500 hidden flex-shrink-0 lg:block">
            <div className="relative rounded-2xl border border-white/[0.08] bg-white/[0.015] p-6">
              {/* Corner brackets */}
              <span className="pointer-events-none absolute left-2 top-2 h-4 w-4 border-l border-t border-signal/40" />
              <span className="pointer-events-none absolute right-2 top-2 h-4 w-4 border-r border-t border-signal/40" />
              <span className="pointer-events-none absolute bottom-2 left-2 h-4 w-4 border-b border-l border-signal/40" />
              <span className="pointer-events-none absolute bottom-2 right-2 h-4 w-4 border-b border-r border-signal/40" />
      ...
      <div id="work" className="mx-auto max-w-7xl scroll-mt-24 px-6">
